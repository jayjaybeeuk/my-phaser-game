...
- **Central Cavern**: Standard platforming mechanics, introduction to core gameplay
- **Underground Chamber**: Classic hazard navigation with increased difficulty
- **Arctic Zone**: Ice physics with momentum-based sliding - player builds speed and slides on icy platforms, creating unique movement challenges
...
- `LevelManager` - Level data and progression
